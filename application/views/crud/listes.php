    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo" href="../../index.html"><img src="<?php echo base_url(); ?>assets/css-admin/images/logo.svg" alt="logo" /></a>
          <a class="navbar-brand brand-logo-mini" href="../../index.html"><img src="<?php echo base_url(); ?>assets/css-admin/images/logo-mini.svg" alt="logo" /></a>
        </div>
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              <div class="col-lg-6 grid-margin stretch-card">
                <div class="card">
                  <form action="<?php echo base_url(); ?>/index.php/admin/crud_plat">
                  <div class="card-body">
                    <h4 class="card-title">Tous les Plats </h4>
                    <p class="card-description"> Add Plats <code>.Plats</code>
                    </p>
            ...
            <!-- <button type="button" class="btn btn-outline-warning btn-icon-text">
              ...
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Tous les Activités</h4>
                    <p class="card-description"> Add Activités <code>Activités</code>
                    </p>
                    <!-- <table class="table table-striped">
                      ...
                      <tbody>
                        <tr>
                          <td class="py-1">
                            <img src="<?php echo base_url(); ?>assets/css-admin/images/faces-clipart/pic-1.png" alt="image" />
                          </td>
                          <td> Herman Beck </td>
                          <td>
                            <div class="progress">
                        ...
                        <tr>
                          <td class="py-1">
                            <img src="<?php echo base_url(); ?>assets/css-admin/images/faces-clipart/pic-2.png" alt="image" />
                          </td>
                          <td> Messsy Adam </td>
                          <td>
                            <div class="progress">
                        ...
                        <tr>
                          <td class="py-1">
                            <img src="<?php echo base_url(); ?>assets/css-admin/images/faces-clipart/pic-3.png" alt="image" />
                          </td>
                          <td> John Richards </td>
                          <td>
                            <div class="progress">
                        ...
                        <tr>
                          <td class="py-1">
                            <img src="<?php echo base_url(); ?>assets/css-admin/images/faces-clipart/pic-4.png" alt="image" />
                          </td>
                          <td> Peter Meggik </td>
                          <td>
                            <div class="progress">
              ...
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form action="<?php echo base_url(); ?>/index.php/admin/crud_activite">
                    <table class="table table-hover">
                      <thead>
                        <tr>
                          <th>idActivite</th>
            ...
            <input class="btn btn-outline-success btn-fw" type="submit" value="Ajouter" />    
              ...
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Régime</h4>
                    <p class="card-description"> Add class <code>.table-dark</code>
                    </p>
                    <form action="<?php echo base_url(); ?>/index.php/admin/crud_regime">
                    <table class="table table-hover">
                      <thead>
                        <tr>
                          <th>Objectif</th>
